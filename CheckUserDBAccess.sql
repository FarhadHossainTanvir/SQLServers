...
DECLARE @DBName varchar(100) = NULL -- 'single_DB' -- NULL=ALL Database
DECLARE @showResltForUser varchar(1000) = NULL -- 'login1,login2...loginN' -- NULL = show result for all users
